...
public class TestConversionService {
	...
	public static void main(String[] args) {
		...
		System.out.println(ConversionService.ounces(new BigDecimal(50)).doubleValue());
		System.out.println(ConversionService.pints(6.6f));
		System.out.println(ConversionService.pounds(new BigDecimal(7.7)).doubleValue());

		// can you figure out why these do not compile
		ConversionService.fluidOunces((float)1.1);
		ConversionService.grams(BigInteger.valueOf(30L)).doubleValue();
		ConversionService.milliliters((int)4.0);
		short grams = (short) ConversionService.grams(new BigInteger("30")).longValue();
		byte byteGrams = (byte)ConversionService.grams(new BigInteger("30")).longValue();
		...
		System.out.println(ConversionService.ounces(BigDecimal.valueOf(50.5f)).doubleValue());
		System.out.println(ConversionService.pints(6L));
		System.out.println(ConversionService.pounds(BigDecimal.valueOf(7L)).doubleValue());
		...
		System.out.println("------------------------------------");
		int bigGrams = (int) ConversionService.grams(new BigInteger("1234567890")).longValue();
